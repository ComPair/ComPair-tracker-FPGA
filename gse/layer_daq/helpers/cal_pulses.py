...
def main(channel, config_file, n_pulse, pulse_delay_ms=PULSE_DELAY_MS):
    """
    Take cal pulse data.
    """
    client = Client() ## Connect to the silicon layer server.
    with open(config_file, "rb") as f:
        cfg = VataCfg.from_binary(f.read())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file", "-c", type=str, default="./default.config")
    ...
    main(args.channel, args.config_file, args.n_pulses, args.pulse_delay)
