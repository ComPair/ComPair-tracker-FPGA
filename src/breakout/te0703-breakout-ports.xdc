...
#set_property PACKAGE_PIN U4   [get_ports P2-DIG-VSS-SHDN]
#set_property PACKAGE_PIN T4   [get_ports P2-TELEM1-CSn]
#set_property PACKAGE_PIN V8   [get_ports P2-TELEM1-MOSI]
#set_property PACKAGE_PIN AB9  [get_ports P2-TELEM1-MISO]
#set_property PACKAGE_PIN AB10 [get_ports P2-TELEM1-SCLK]
#set_property PACKAGE_PIN W10  [get_ports P2-DIG-CAL-DAC-SYNCn]
#set_property PACKAGE_PIN AA8  [get_ports P2-DIG-CAL-DAC-SCLK]
#set_property PACKAGE_PIN AA9  [get_ports P2-DIG-CAL-DAC-MOSI]
#set_property PACKAGE_PIN AB11 [get_ports P2-DIG-CAL-PULSE-TRIGGER]
#set_property PACKAGE_PIN AA11 [get_ports P2-i3-GALAO]
#set_property PACKAGE_PIN AB12 [get_ports P2-i4-GALAO]
#set_property PACKAGE_PIN AA12 [get_ports P2-caldb-GALAO]
#set_property PACKAGE_PIN AB16 [get_ports P2-cald-GALAO]
#set_property PACKAGE_PIN AA16 [get_ports P2-o5-GALAO]
#set_property PACKAGE_PIN AB17 [get_ports P2-s2-GALAO]
#set_property PACKAGE_PIN AA17 [get_ports P2-i1-GALAO]
#set_property PACKAGE_PIN AA18 [get_ports P2-s1-GALAO]
#set_property PACKAGE_PIN Y18  [get_ports P2-s0-GALAO]
#set_property PACKAGE_PIN AB21 [get_ports P2-s-latch-GALAO]
#set_property PACKAGE_PIN AA21 [get_ports P2-ASIC-TRIGGER-OUT]
