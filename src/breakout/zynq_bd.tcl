...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_trigger1, and set properties
  set axi_gpio_trigger1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_trigger1 ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_ALL_OUTPUTS_2 {1} \
   CONFIG.C_GPIO2_WIDTH {1} \
  ...
  # Create instance: axi_gpio_trigger_ena1, and set properties
  set axi_gpio_trigger_ena1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_trigger_ena1 ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins vata_460p3_axi_inter_1/s00_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins axi_fifo_mm_s_data1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_trigger1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_trigger_ena1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net P3_ASIC_TRIGGER_OUT_1 [get_bd_ports P3_ASIC_TRIGGER_OUT] [get_bd_pins ila_1/probe9] [get_bd_pins vata_460p3_axi_inter_1/vata_o6]
  connect_bd_net -net P3_o5_GALAO_1 [get_bd_ports P3_o5_GALAO] [get_bd_pins ila_1/probe8] [get_bd_pins vata_460p3_axi_inter_1/vata_o5]
  ...
  connect_bd_net -net axi_fifo_mm_s_data1_interrupt [get_bd_pins axi_fifo_mm_s_data1/interrupt] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_trigger0/gpio_io_o] [get_bd_pins ila_0/probe15] [get_bd_pins vata_460p3_axi_inter_0/trigger_ena_force]
  connect_bd_net -net axi_gpio_force_trigger_gpio2_io_o [get_bd_pins axi_gpio_trigger0/gpio2_io_o] [get_bd_pins ila_0/probe14] [get_bd_pins vata_460p3_axi_inter_0/trigger_ack]
  connect_bd_net -net axi_gpio_trigger1_gpio2_io_o [get_bd_pins axi_gpio_trigger1/gpio2_io_o] [get_bd_pins vata_460p3_axi_inter_1/trigger_ack]
  connect_bd_net -net axi_gpio_trigger1_gpio_io_o [get_bd_pins axi_gpio_trigger1/gpio_io_o] [get_bd_pins vata_460p3_axi_inter_1/trigger_ena_force]
  connect_bd_net -net axi_gpio_trigger_ena1_gpio_io_o [get_bd_pins axi_gpio_trigger_ena1/gpio_io_o] [get_bd_pins vata_460p3_axi_inter_1/trigger_ena_ena]
  connect_bd_net -net axi_gpio_trigger_ena_gpio_io_o [get_bd_pins axi_gpio_trigger_ena0/gpio_io_o] [get_bd_pins ila_0/probe13] [get_bd_pins vata_460p3_axi_inter_0/trigger_ena_ena]
  connect_bd_net -net fee_hit_fast_or_0_fee_hit_or [get_bd_pins ila_1/probe13] [get_bd_pins util_reduced_logic_0/Res] [get_bd_pins vata_460p3_axi_inter_0/trigger_ena] [get_bd_pins vata_460p3_axi_inter_1/trigger_ena]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_fifo_mm_s_data0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_data1/s_axi_aclk] [get_bd_pins axi_gpio_trigger0/s_axi_aclk] [get_bd_pins axi_gpio_trigger1/s_axi_aclk] [get_bd_pins axi_gpio_trigger_ena0/s_axi_aclk] [get_bd_pins axi_gpio_trigger_ena1/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ila_2/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins vata_460p3_axi_inter_0/s00_axi_aclk] [get_bd_pins vata_460p3_axi_inter_1/s00_axi_aclk] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_data0/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_data1/s_axi_aresetn] [get_bd_pins axi_gpio_trigger0/s_axi_aresetn] [get_bd_pins axi_gpio_trigger1/s_axi_aresetn] [get_bd_pins axi_gpio_trigger_ena0/s_axi_aresetn] [get_bd_pins axi_gpio_trigger_ena1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins vata_460p3_axi_inter_0/s00_axi_aresetn] [get_bd_pins vata_460p3_axi_inter_1/s00_axi_aresetn]
  connect_bd_net -net vata_460p3_axi_inter_0_FEE_hit [get_bd_pins ila_0/probe11] [get_bd_pins vata_460p3_axi_inter_0/FEE_hit] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net vata_460p3_axi_inter_0_abort_daq [get_bd_pins ila_2/probe5] [get_bd_pins vata_460p3_axi_inter_0/abort_daq]
  ...
  connect_bd_net -net vata_460p3_axi_inter_0_cal_pulse_trigger_out [get_bd_ports P2_DIG_CAL_PULSE_TRIGGER] [get_bd_pins ila_0/probe1] [get_bd_pins vata_460p3_axi_inter_0/cal_pulse_trigger_out]
  ...
  connect_bd_net -net vata_460p3_axi_inter_0_trigger_ack_timeout_counter [get_bd_pins ila_2/probe4] [get_bd_pins vata_460p3_axi_inter_0/trigger_ack_timeout_counter]
  connect_bd_net -net vata_460p3_axi_inter_0_trigger_ack_timeout_state [get_bd_pins ila_2/probe3] [get_bd_pins vata_460p3_axi_inter_0/trigger_ack_timeout_state]
  ...
  connect_bd_net -net vata_460p3_axi_inter_1_FEE_hit [get_bd_pins ila_1/probe10] [get_bd_pins vata_460p3_axi_inter_1/FEE_hit] [get_bd_pins xlconcat_2/In1]
  connect_bd_net -net vata_460p3_axi_inter_1_abort_daq [get_bd_pins ila_2/probe2] [get_bd_pins vata_460p3_axi_inter_1/abort_daq]
  connect_bd_net -net vata_460p3_axi_inter_1_cal_dac_spi_mosi [get_bd_ports P3_DIG_CAL_DAC_MOSI] [get_bd_pins vata_460p3_axi_inter_1/cal_dac_spi_mosi]
  connect_bd_net -net vata_460p3_axi_inter_1_cal_dac_spi_sclk [get_bd_ports P3_DIG_CAL_DAC_SCLK] [get_bd_pins vata_460p3_axi_inter_1/cal_dac_spi_sclk]
  connect_bd_net -net vata_460p3_axi_inter_1_cal_dac_spi_syncn [get_bd_ports P3_DIG_CAL_DAC_SYNCn] [get_bd_pins vata_460p3_axi_inter_1/cal_dac_spi_syncn]
  connect_bd_net -net vata_460p3_axi_inter_1_cal_pulse_trigger_out [get_bd_ports P3_DIG_CAL_PULSE_TRIGGER] [get_bd_pins ila_1/probe12] [get_bd_pins vata_460p3_axi_inter_1/cal_pulse_trigger_out]
  ...
  connect_bd_net -net vata_460p3_axi_inter_1_state_out [get_bd_pins ila_1/probe0] [get_bd_pins vata_460p3_axi_inter_1/state_out]
  connect_bd_net -net vata_460p3_axi_inter_1_trigger_ack_timeout_counter [get_bd_pins ila_2/probe1] [get_bd_pins vata_460p3_axi_inter_1/trigger_ack_timeout_counter]
  connect_bd_net -net vata_460p3_axi_inter_1_trigger_ack_timeout_state [get_bd_pins ila_2/probe0] [get_bd_pins vata_460p3_axi_inter_1/trigger_ack_timeout_state]
  connect_bd_net -net vata_460p3_axi_inter_1_trigger_acq_out [get_bd_pins ila_1/probe11] [get_bd_pins vata_460p3_axi_inter_1/trigger_acq_out]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_i1 [get_bd_ports P3_i1_GALAO] [get_bd_pins ila_1/probe1] [get_bd_pins vata_460p3_axi_inter_1/vata_i1]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_i3 [get_bd_ports P3_i3_GALAO] [get_bd_pins ila_1/probe2] [get_bd_pins vata_460p3_axi_inter_1/vata_i3]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_i4 [get_bd_ports P3_i4_GALAO] [get_bd_pins ila_1/probe3] [get_bd_pins vata_460p3_axi_inter_1/vata_i4]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_s0 [get_bd_ports P3_s0_GALAO] [get_bd_pins ila_1/probe4] [get_bd_pins vata_460p3_axi_inter_1/vata_s0]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_s1 [get_bd_ports P3_s1_GALAO] [get_bd_pins ila_1/probe5] [get_bd_pins vata_460p3_axi_inter_1/vata_s1]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_s2 [get_bd_ports P3_s2_GALAO] [get_bd_pins ila_1/probe6] [get_bd_pins vata_460p3_axi_inter_1/vata_s2]
  connect_bd_net -net vata_460p3_axi_inter_1_vata_s_latch [get_bd_ports P3_s_latch_GALAO] [get_bd_pins ila_1/probe7] [get_bd_pins vata_460p3_axi_inter_1/vata_s_latch]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_trigger1/S_AXI/Reg] SEG_axi_gpio_trigger1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_trigger_ena1/S_AXI/Reg] SEG_axi_gpio_trigger_ena1_Reg
