...
ssh root@${IP_ADDR} "ln -sf $DEST_DIR/scripts2/onboot.sh  /etc/rcS.d/S999_onboot.sh"
ssh root@${IP_ADDR} "ln -sf $DEST_DIR/scripts/fee_disable.sh  /etc/rc6.d/K999_fee_disable.sh"
ssh root@${IP_ADDR} "ln -sf $DEST_DIR/scripts/fee_disable.sh  /etc/rc0.d/K999_fee_disable.sh"