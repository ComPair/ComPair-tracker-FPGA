...
set_property -dict { PACKAGE_PIN B13-IO0   IOSTANDARD LVCMOS33 } [get_ports { ETH_LED[0] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN B13-IO25   IOSTANDARD LVCMOS33 } [get_ports { ETH_LED[1] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
